...
(use-package elscreen
  ...
  :config
    ...
    ;; disable tabs since they conflict with semantic notifications.
    ;; Can always be displayed with helm-elscreen
    ...
    ;; Regardless of other settings, this must always occur to hide tabs
    ;; when we go into a terminal
