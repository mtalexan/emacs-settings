;; Extends ivy to set different display transformers, e.g.
;; `ivy-switch-buffer' has more content
...
(use-package ivy-rich
  ...
  :init
    ...
    (ivy-rich-mode 1)
  :config
    ;; Actually use this package as the display transformer for
    ;; `ivy-switch-buffer'
    ;; This method is deprecated, replaced with (ivy-rich-mode 1)
